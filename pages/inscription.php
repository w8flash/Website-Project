    ...
    <form method="POST" class="form login">
      <div class="form__field">
        <label for="login__mail"><svg class="icon">
          ...
          </svg><span class="hidden">Mail</span></label>
        <input autocomplete="mail" id="login__mail" type="text" name="mail" class="form__input" placeholder="Mail" required>
      </div>
      ...
      <div class="form__field">
        <input type="submit" name="inscription" value="Sign In">
      </div>
...
<?php
  ...
  if(isset($_POST['inscription'])) {
      ...
      $req = $pdo->prepare("INSERT INTO user (mail, username, mdp) values ('$email', '$username', '$mdp') ");
